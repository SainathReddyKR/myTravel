class PostAttachmentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @post_attachment.update(post_attachment_params)
        format.html { redirect_to @post_attachment.driverride, notice: 'Post attachment was successfully updated.' }
      end
    end
  end
  ...
  private
    ...
    def post_attachment_params
      params.require(:post_attachment).permit(:driverride_id, :avatar)
    end
end
